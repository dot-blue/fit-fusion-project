      ...
      <div className="max-w-[1240px] m-auto ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 ">
          <div className=" flex flex-col   w-full items-center p-6 ">
            <p className="">Tailored to each individual</p>
            <p className="">
          ...
          <div className=" flex flex-col  w-full items-center p-6">
            ...
            <p>
              Losing weight can be a tough journey, but you don't have to go it
              alone. Our community of clients and trainers offer support and
              motivation to help you stay on track and reach your goals.{" "}
            </p>
            <img src={perk2} alt="perk2" />
          </div>

          <div className=" flex flex-col   w-full items-center p-6">
            <p>Challenging workouts</p>
            <p>
